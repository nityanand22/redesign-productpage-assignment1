    ...
    return (
        <nav className="w-full bg-gradient-to-r from-[#09122C] to-[#1A2B4C] shadow-lg">
            <div className="max-w-[1538px] mx-auto px-4 w-full">
                <div className="flex justify-between h-20 items-center px-6 lg:px-10">
                    {/* Logo */}
                    ...
                    <div className="hidden lg:flex items-center space-x-8 text-lg font-medium">
                        {menuItems.map((item) => (
                            <li
                                key={item.text}
                                className="text-white list-none transition-all duration-300 hover:text-[#FFD700] cursor-pointer"
                                onClick={() =>
                                    scrollToSection && item.ref
                                        ? scrollToSection(item.ref)
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        {user?.role?.[0] === 'admin' ? (
                            <Button
                                variant="solid"
                                className="rounded-[5px] bg-[#FFD700] text-black hover:bg-[#FFC300] transition-all"
